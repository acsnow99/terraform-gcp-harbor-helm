...
CMD /auto-backup.sh && cd minecraft && /minecraft/bedrock_server' > ./k8s-minecraft-image/Dockerfile

#This command keeps the container running
#CMD tail -f /dev/null 

sudo docker build -t alexcraigs/k8s-minecraft:"${worldname}" ./k8s-minecraft-image
